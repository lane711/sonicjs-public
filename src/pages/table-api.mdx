...
## Create content {{ tag: 'POST', label: '/v1/user' }}
...
## Update content {{ tag: 'PUT', label: '/v1/user/9d370085-c116-47c9-9b22-7f33061ec7b9' }}
...
## Delete content {{ tag: 'DELETE', label: '/v1/user/9d370085-c116-47c9-9b22-7f33061ec7b9' }}
