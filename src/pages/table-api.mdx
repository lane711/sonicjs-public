...
<table>
   ...
   <tbody>
      <tr>
         <td>Equals</td>
         <td><code>$eq</code></td>
         <td>Equal to (use $contains for case insensitive)</td>
      </tr>
      <tr>
         <td>Doesn't equal</td>
         <td><code>$neq</code></td>
...
## Create a record {{ tag: 'POST', label: '/api/v1/:table-name' }}
...
## Update a record {{ tag: 'PUT', label: '/api/v1/posts/8f730853-d74e-4ce3-a059-b496200191eb' }}
...
business logic. For this, you'll want to check out the docs for SonicJS [routing](/routing).
