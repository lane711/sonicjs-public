...
Examples:<br/>
        GET /v1/categories?sort=title - to sort on 1 field<br/>
GET /v1/categories?sort[0]=title:desc&sort[1]=body:asc - to sort on multiple fields<br/>
      </Property>
      ...
      <Property name="filters" type="array">
        ...
        GET /v1/:tableName?filters[field][operator]=value<br/>
        Examples:<br/>
        /v1/categories?filters[title][$eq]=hello<br/>
...
## Retrieve a user record via session {{ tag: 'GET', label: '/v1/user' }}
...
http://localhost:8788/v1/user  -H "Authorization: Bearer x555nastyhnyr2j6kyfypykos50daei3yer0fwcu3"
