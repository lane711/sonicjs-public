...
Copy `/wrangler.example.toml` to `/wrangler.toml` and update the 4 required Cloudfalre values:
...
The first thing you will want to do is define your first [table](/table).