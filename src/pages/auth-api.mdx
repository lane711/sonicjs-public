...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    http://localhost:8788/api/v1/auth/user -H "Authorization: Bearer session-token"
    ```
    </CodeGroup>
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    http://localhost:8788/api/v1/auth/logout -H "Authorization: Bearer session-token"
    ```
    </CodeGroup>
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    http://localhost:8788/api/v1/auth/password/reset/send/user%40example.com
    ```
    </CodeGroup>
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    http://localhost:8788/api/v1/auth/password/otp/user%40example.com
    ```
    </CodeGroup>
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    http://localhost:8788/api/v1/auth/email-confirmation/send/user%40example.com
    ```
    </CodeGroup>
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    http://localhost:8788/api/v1/auth/email-confirmation/receive/confirmation-code
    ```
    </CodeGroup>
  </Col>
</Row>
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    http://localhost:8788/api/v1/auth/email-exists/user%40example.com
    ```
    </CodeGroup>
