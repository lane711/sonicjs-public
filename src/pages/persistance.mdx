...
Its also a good idea to manually review the migration file to make sure it is making the intended updates to you database before running it against your database.
