...
SonicJs uses <a href="https://hono.dev/" target="_blank">Hono</a> for routing. Hono is an ultra fast routing system for edge frameworks. Please see their docs for any routing 
